...
// void displayInteractiveMessage();
...
void setup() {
  ...
  // Display interactive message or greeting
...
void display_time(struct tm timeinfo) {
  ...
  // If it's PM, display a dot after the minutes
  // if (is_pm) {
  //   myLedDisplay.setDecimalPoint(2);
  // }
...
void get_internal_timestamp(char** out_val) {
  ...
  /* Testing purpose */
  // ESP_LOGI(pcTaskGetName(0), "timeinfo.tm_sec=%d", timeinfo.tm_sec);
  // ESP_LOGI(pcTaskGetName(0), "timeinfo.tm_min=%d", timeinfo.tm_min);
  // ESP_LOGI(pcTaskGetName(0), "timeinfo.tm_hour=%d", timeinfo.tm_hour);
  // ESP_LOGI(pcTaskGetName(0), "timeinfo.tm_wday=%d", timeinfo.tm_wday);
  // ESP_LOGI(pcTaskGetName(0), "timeinfo.tm_mday=%d", timeinfo.tm_mday);
  // ESP_LOGI(pcTaskGetName(0), "timeinfo.tm_mon=%d", timeinfo.tm_mon);
  // ESP_LOGI(pcTaskGetName(0), "timeinfo.tm_year=%d", timeinfo.tm_year);
